...
CREATE TABLE "registered_applications" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar, "url" varchar, "user_id" integer, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "verified" boolean DEFAULT 'f', "verification_code" varchar);
...
INSERT INTO schema_migrations (version) VALUES ('20150502013725');

INSERT INTO schema_migrations (version) VALUES ('20150502013918');
