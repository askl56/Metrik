...
CREATE TABLE "events" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar, "registered_application_id" integer, "json" payload DEFAULT '--- {}
...
INSERT INTO schema_migrations (version) VALUES ('20150423030802');
